...
#### Мои допуски (если что-то не забыл)
1. Я допустил что босс находится всегда на последнем этаже и он только один
2. Если игрок вышел из данжа то в него не может вернуться
3. Время зачиски этажа считается только если игрок на этаже(Если игрок на первом этаже был 10 минут, потом ушел на второй и через некоторое время вернулся на первый этаж и зачистил его за 20 минут, то время зачиски первого этажа будет равно 30 минут)
4. От босса можно сбежать и время его прохождения будет считаться так же как описано в пункте 3
5. Между поднятием на этаж босса и заходом к нему может быть время в которое игрок может выполнять действия, но не может получать урона и убить босса и этот промежуток не идет в счет времени на убийство босса
